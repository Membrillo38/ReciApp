...
def build_recipe_prompt(target_language: str, source_json: str) -> str:
    return (
        ...
        "Split quantity and unit into separate fields: quantity holds only the amount "
        "(e.g. '0.5', '1 1/2', 'to taste'); unit holds only the unit "
        "(prefer wire forms: g, kg, ml, l, cup, tbsp, tsp, fl oz, oz, lb). "
        "Never put '1/2 cup' into both fields or into name.\n"
        "Set density_g_per_ml to null always. The server fills culinary density from an "
        "authorized table when known. Do not invent, estimate, or convert densities. "
        "Do not set density for countable items (egg, clove, piece) or 'to taste' amounts.\n"
